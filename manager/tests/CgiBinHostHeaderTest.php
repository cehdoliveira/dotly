...
/**
 * Regressao do bug corrigido no plano 027: kafka_email_worker.php simulava
 * $_SERVER["HTTP_HOST"] com o host do SITE em vez do proprio MANAGER, e o
 ...
 * script cgi-bin do MANAGER hardcoda um host fora do ALLOWED_HOSTS deste
 * ambiente.
 */
