 ...
 * LoginActiveFilterTest para os fluxos que dependem do front controller). Por
 * isso os testes aqui cobrem o que da pra verificar sem servidor HTTP: a
 * pagina de 404 existe e nao tem erro de sintaxe, e o fallback no fonte do
 * index.php usa http_response_code(404) em vez de basic_redir($home_url). A
 * verificacao de comportamento real (404/200/302 via curl, incluindo o caso
 * "sem login em rota inexistente") fica fora do PHPUnit — ver relatorio do
 * plano 019.
 */
